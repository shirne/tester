...
class ScrollPanelPage extends StatefulWidget {
  const ScrollPanelPage({super.key});

  @override
  State<ScrollPanelPage> createState() => _ScrollPanelPageState();
}

class _ScrollPanelPageState extends State<ScrollPanelPage> {
  @override
...
class DragController {
  ...
  void updateDragDistance(
    ...
    if (_dragListener != null) {
      _dragListener?.call(dragDistance, isDragEnd);
    }
  }
}
...
class MyVerticalDragGestureRecognizer extends VerticalDragGestureRecognizer {
  ...
  MyVerticalDragGestureRecognizer(
      {Object? debugOwner, required this.flingListener})
